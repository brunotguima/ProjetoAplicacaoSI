...
<div class="ui container">
  ...
  <h2 class="ui dividing header">Gerenciamento de Veículos <a href="{{route('veiculos.create')}}"><i
      ...
      <div class="four wide column">
        <div class="ui card">
          ...
          <div class="extra content center aligned page grid">
            ...
            <label class="ui green horizontal label">Disponível!</label>
            @else
            <label class="ui red horizontal label">Em uso!</label>
            @endif
          </div>
          <div class="extra content center aligned page grid">
              <button class="ui icon blue button" onclick="qrcode({{$veiculo->id}},'{{$veiculo->modelo}}');"><i
                  class="qrcode icon"></i></button>
            <button class="orange icon button ui"> <a href="{{route('veiculos.show',$veiculo->id)}}"><i
                  class="eye icon"></i></a></button>
            <button class="green icon button ui"> <a href="{{route('veiculos.edit',$veiculo->id)}}"><i
